...
'The number of dimensions of an array. An unallocated dynamic array has 0 dimensions. 
...
'Number of elements in the specified dimension (Dimension) of the array in Arr. 
'If you omit Dimension, the first dimension is used. The function will return
