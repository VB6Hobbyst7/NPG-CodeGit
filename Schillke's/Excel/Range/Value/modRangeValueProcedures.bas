Attribute VB_Name = "modRangeValueProcedures"
Option Explicit
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' modDistinctValues
' By Chip Pearson, 5-November-2007, chip@cpearson.com, www.cpearson.com
' This page: http://www.cpearson.com/excel/distinctvalues.aspx
'
...
Public Function DistinctValues(InputValues As Variant, _
    Optional IgnoreCase As Boolean = False) As Variant
'Accepts a set of values in InputValues and returns an Array
...
' account and 'abc' is treated differently than 'ABC'. RequiredLevel:4
...
Private Function NumberOfArrayDimensions(Arr As Variant) As Long
''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Private Function Transpose1DArray(Arr As Variant, ToRow As Boolean) As Variant
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Transpose1DArray
